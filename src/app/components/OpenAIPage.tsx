      ...
      <div className="p-4 sm:p-6 lg:p-8 pt-20 sm:pt-24">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-6">
            {/* Phishing Status */}
            <div
              className={`bg-[#232323] rounded-2xl p-6 border ${email.phishingDetected ? "border-[#ff4d2e]/30" : "border-green-500/30"}`}
            >
              ...
              <p
                className={`text-3xl font-normal mb-2 ${email.phishingDetected ? "text-[#ff4d2e]" : "text-green-500"}`}
              >
            ...
            {/* VirusTotal */}
            <div
              className={`bg-[#232323] rounded-2xl p-6 border ${email.virusTotalResults.threats > 50 ? "border-[#ff4d2e]/30" : "border-white/5"}`}
            >
              <div className="flex items-center gap-3 mb-4">
              ...
              <p
                className={`text-3xl font-normal mb-2 ${email.virusTotalResults.threats > 50 ? "text-[#ff4d2e]" : email.virusTotalResults.threats > 20 ? "text-yellow-500" : "text-green-500"}`}
              >
                {email.virusTotalResults.threats}/{totalEngines}
              </p>
              <p className="text-white/50 text-xs">Threat detections</p>
            </div>

            {/* Data Breaches */}
            <div
              className={`bg-[#232323] rounded-2xl p-6 border ${email.breachCount > 0 ? "border-[#ff4d2e]/30" : "border-white/5"}`}
            >
              <div className="flex items-center gap-3 mb-4">
              ...
              <p
                className={`text-3xl font-normal mb-2 ${email.breachCount > 0 ? "text-[#ff4d2e]" : "text-green-500"}`}
              >
                {email.breachCount}
              </p>
              <p className="text-white/50 text-xs">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-xs">
                        Delete this email immediately. Do not click any links or
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-xs">
                        The sender's email has been in data breaches. Verify
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 text-xs">
                          This email appears legitimate. However, always
        ...
        <div className="mt-8 bg-[#121212] rounded-2xl p-6 border border-white/5">
          <h4 className="text-white/60 text-xs uppercase tracking-wide mb-3">
            About OpenAI Analysis
          </h4>
          <p className="text-white/80 text-sm leading-relaxed">
            Our OpenAI integration uses advanced language models to analyze
            email content, sender patterns, and metadata to provide intelligent
            insights, comprehensive summaries, and actionable mitigation
            recommendations. The analysis combines data from phishing detection,
            VirusTotal, and HaveIBeenPwned to deliver a complete security
            assessment with step-by-step guidance on how to respond to potential
            threats.
          </p>
        </div>
      </div>
